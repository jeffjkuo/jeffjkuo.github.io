...
-   Primary Conclusions
    ...
    2. Taiwan is blocked, not because of purely political reasons.
...
-   Future Work
    ...
    1. Apply **heterogeneous shocks** to different production sectors, according to the updated tariff reduction schedule
    
    2. Explore more possible shocks in policy tools, i.e., like blockade 
      - <small> This is on the horizon with Anton Yang. </small>
    
    3. Expand the analysis to exam the potential PTAs, i.e., CPTPP, U.S.-Taiwan Initiative on 21st-Century Trade.
