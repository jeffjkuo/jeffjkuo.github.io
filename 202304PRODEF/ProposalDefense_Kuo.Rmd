...
# Chapter 2: Network of Exporting Computer 
...
- Application
  - [World Integrated Trade Solution (WITS)](https://wits.worldbank.org/WITS/WITS/Restricted/Login.aspx)

- We use the API program in R to extract the data
  - [R Package ITNr](https://cran.r-project.org/web/packages/ITNr/index.html)

- Taiwan is not included in the database as a "country." 
  - Specifically, we must find region code "nes, Asia."

---

# Chapter 2 | Methodology

1. Our first step was calling out all the packages we needed in R and searching for product codes. We put this keyword into the “comtradr” package in R to search for computer-related products.
