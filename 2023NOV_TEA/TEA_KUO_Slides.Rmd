...
subtitle: "In global trade, how important is Taiwan's (PC) industry?"
author: "Jeffrey Kuo"
...
I was hoping to be in Taipei by now.
...
- <u>**find**</u> more about my latest work -> <https://jeffjkuo.github.io>
...
- What was the process of building the world's PC manufacturing center?

- How do we measure the role of the industry in global trade? 
  - **degree of centrality**

- Does the trade liberalization change play any role?

- Could we demonstrate the evolution by using International Trade Network analysis?

- Are we still in **center** of the trade network now?

## Contributions

  - Develop an algorithm to analyze Taiwan's role in global trade graphically.
    - Does not have to be limited to PC; the algorithm potentially could expand to other industries. 
  
  - Demonstrate the evolution of the centrality of the Taiwan-PC industry.
