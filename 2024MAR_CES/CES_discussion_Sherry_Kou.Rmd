...
- The paper is very readable!
  ...
  - The Figure 1 is especially helpful to set up the idea of "Tax Haven" and the mechcanism of "US - Tax Haven - China" linkage. 
...
- The author uses an example of APPLE.Inc. But if you can provide some numbers inside of the example, I thought it would be better. i.e., However much taxes does this manipulation save in terms of the taxes? (maybe it is taken as common knowledge in the IP papers?)
